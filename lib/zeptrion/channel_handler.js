            ...
            if(val === 1000 || val === '1000'){
                ...
                request(url, function(err, res, body) {
                    ...
                    if (res.statusCode === 200){
                        ...
                        if('type' in body && body.type === 'static'){
                            info = body
                        }else{
            ...
            device_objs.forEach(function(device_obj){
                ...
                adapter.getChannelsOf(device_obj._id, function(err, channel_objs){   
                    ...
                    channel_objs.forEach(function(channel_obj){
                        let is_zept_room = (channel_obj.native.room === room_obj.common.name)
                        ...
                        if(!is_zept_room && is_channel_in_room){
                            // add to room
                            channel_obj.native.room = room_obj.common.name
                            adapter.setObject(channel_obj._id, channel_obj)
                            device_type_class.change_room_on_device(channel_obj, room_obj.common.name, adapter)
                        }
                    })
                })
            })
