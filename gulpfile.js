...
gulp.task('rename', function ()  {
    ...
    if (!newname) {
        console.log('Please write the new zeptrion name, like: "gulp rename --name mywidgetset" --author "Author Name"');
        process.exit();
    }
    ...
    if (fs.existsSync(__dirname + '/admin/zeptrion.png')) {
        fs.renameSync(__dirname + '/admin/zeptrion.png',              __dirname + '/admin/' + newname + '.png');
    }
    if (fs.existsSync(__dirname + '/widgets/zeptrion.html')) {
        fs.renameSync(__dirname + '/widgets/zeptrion.html',           __dirname + '/widgets/' + newname + '.html');
    }
    if (fs.existsSync(__dirname + '/widgets/zeptrion/js/zeptrion.js')) {
        fs.renameSync(__dirname + '/widgets/zeptrion/js/zeptrion.js', __dirname + '/widgets/zeptrion/js/' + newname + '.js');
    }
    if (fs.existsSync(__dirname + '/widgets/zeptrion')) {
        fs.renameSync(__dirname + '/widgets/zeptrion',                __dirname + '/widgets/' + newname);
    }
    var patterns = [
        {
            match: /zeptrion/g,
